                    ...
                    <div style='font-family: Arial, Helvetica, sans-serif; max-width: 480px; margin: 0 auto; border: 1px solid #e5e0d8; border-radius: 6px; overflow: hidden;'>
                        ...
                        <div style='padding: 32px;'>
                            ...
                            <div style='text-align: center; margin: 0 0 24px;'>
                                <a href='{encodedCallbackUrl}' style='background: #c9a64b; color: #0d0d0d; text-decoration: none; font-weight: bold; padding: 14px 32px; border-radius: 4px; display: inline-block; font-size: 15px;'>Reset My Password</a>
                            </div>
