...
public static class SeedData
{
    ...
    private static async Task<ApplicationUser> SeedRolesAndAdminAsync(IServiceProvider services)
    {
        ...
        foreach (var role in new[] { "Admin", "Customer", "Merchant", "Wholesale" })
        {
        ...
        const string adminEmail = "admin@worldlinkmaster.com";
        ...
        if (adminUser == null)
        {
            ...
            // Dev-only seeded credential. Change this password before any real deployment.
